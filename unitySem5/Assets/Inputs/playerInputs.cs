...
public partial class @PlayerInputs : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""UiRelated"",
            ""id"": ""9b3a484b-7328-4fdf-bc01-fe84c7362f30"",
            ""actions"": [
                {
                    ""name"": ""Echap"",
                    ""type"": ""Button"",
                    ""id"": ""fd1303a6-d082-44f3-8650-afda9c8e5711"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""c7ae9bd9-7ed8-4123-a78e-fce4e2ee24ea"",
    ...
    // UiRelated
    private readonly InputActionMap m_UiRelated;
    private IUiRelatedActions m_UiRelatedActionsCallbackInterface;
    private readonly InputAction m_UiRelated_Echap;
    public struct UiRelatedActions
    {
        private @PlayerInputs m_Wrapper;
        public UiRelatedActions(@PlayerInputs wrapper) { m_Wrapper = wrapper; }
        public InputAction @Echap => m_Wrapper.m_UiRelated_Echap;
        public InputActionMap Get() { return m_Wrapper.m_UiRelated; }
        public void Enable() { Get().Enable(); }
        public void Disable() { Get().Disable(); }
        public bool enabled => Get().enabled;
        public static implicit operator InputActionMap(UiRelatedActions set) { return set.Get(); }
        public void SetCallbacks(IUiRelatedActions instance)
        {
            if (m_Wrapper.m_UiRelatedActionsCallbackInterface != null)
            {
                @Echap.started -= m_Wrapper.m_UiRelatedActionsCallbackInterface.OnEchap;
                @Echap.performed -= m_Wrapper.m_UiRelatedActionsCallbackInterface.OnEchap;
                @Echap.canceled -= m_Wrapper.m_UiRelatedActionsCallbackInterface.OnEchap;
            }
            m_Wrapper.m_UiRelatedActionsCallbackInterface = instance;
            if (instance != null)
            {
